 ...
 168  006d 00            	dc.b	page(f_TIM4_UPD_OVF_IRQHandler)
 169  006e 0000          	dc.w	f_TIM4_UPD_OVF_IRQHandler
 ...
 176  0075 00            	dc.b	page(f_USART_TX_IRQHandler)
 177  0076 0000          	dc.w	f_USART_TX_IRQHandler
 178  0078 82            	dc.b	130
 180  0079 00            	dc.b	page(f_USART_RX_IRQHandler)
 181  007a 0000          	dc.w	f_USART_RX_IRQHandler
 182  007c 82            	dc.b	130
 184  007d 00            	dc.b	page(f_NonHandledInterrupt)
 185  007e 0000          	dc.w	f_NonHandledInterrupt
 236                     	xdef	__vectab
 237                     	xref	f_USART_RX_IRQHandler
 238                     	xref	f_USART_TX_IRQHandler
